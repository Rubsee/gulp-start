...
//rubsee.ru/catalog_bd.php для обращения к БД
//Повторил лекцию
//Часть кода разобрал через gpt, примерно понял использование операторов '.=' 'AND' функции implode, !empty, intval, $conn->real_escape_string
